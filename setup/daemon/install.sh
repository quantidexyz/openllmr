#!/usr/bin/env bash
# openllm-self-sha256: 4c79dcd0d273b66a35401b8dd4296e847e5b6b666f0eafb78e76e4c7009e6e81
...
record_install_stamp() {
  ...
  (umask 077; printf '%s' "1.0.1" > "$tmp" && mv -f "$tmp" "$dir/setup-daemon.version") 2>/dev/null || { rm -f "$tmp"; true; }
}
clear_install_stamp() {
