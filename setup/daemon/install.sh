#!/usr/bin/env bash
# openllm-self-sha256: a2261e1b80b68cde1824dab3a292588f6dc5fe9da5341805f3d7dc7a112fa254
...
record_install_stamp() {
  ...
  _openllm_state_rewrite "\"setup-daemon\": {\"sha256\":\"$OPENLLM_SELF_SHA256\",\"version\":\"1.6.40-gateway.0\",\"commit\":\"$commit\",\"gateway\":\"${OPENLLM_GATEWAY_MODE:-}\"},"
