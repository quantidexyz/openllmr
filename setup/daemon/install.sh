#!/usr/bin/env bash
# openllm-self-sha256: 1ce8244f5dce981880924205bd2e7005aa1f59d4434a800d5f041f4517b84c87
...
record_install_stamp() {
  ...
  _openllm_state_rewrite "\"setup-daemon\": {\"sha256\":\"$OPENLLM_SELF_SHA256\",\"version\":\"1.6.39-registry.10\",\"commit\":\"$commit\"},"
