#!/usr/bin/env bash
# openllm-self-sha256: 34e5174c36aff9be97d1a049e67d8befc9276b32415668b04e88b1c9db9e3bdd
...
record_install_stamp() {
  ...
  _openllm_state_rewrite "\"setup-daemon\": {\"sha256\":\"$OPENLLM_SELF_SHA256\",\"version\":\"1.6.39\",\"commit\":\"$commit\"},"
