#!/usr/bin/env bash
# openllm-self-sha256: 6cda2e899a499d3ceae2a0673b7106b3564a1198bd88c7605b2e7ac62a4cf636
...
record_install_stamp() {
  ...
  (umask 077; printf '%s' "1.0.1" > "$tmp" && mv -f "$tmp" "$dir/setup-raycast.version") 2>/dev/null || { rm -f "$tmp"; true; }
}
clear_install_stamp() {
