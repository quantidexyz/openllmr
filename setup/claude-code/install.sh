#!/usr/bin/env bash
# openllm-self-sha256: 61313ae9b110e5c677a43b3c47b75a9145379d982f6f53cee192a76d257e8069
...
record_install_stamp() {
  ...
  _openllm_state_rewrite "\"setup-claude-code\": {\"sha256\":\"$OPENLLM_SELF_SHA256\",\"version\":\"1.6.39\",\"commit\":\"$commit\"},"
