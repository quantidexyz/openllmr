#!/usr/bin/env bash
# openllm-self-sha256: 071a971f666421ae63d6065a3735758bc2552bbb05420972bc75668cae12b8bc
...
record_install_stamp() {
  ...
  (umask 077; printf '%s' "1.0.1" > "$tmp" && mv -f "$tmp" "$dir/setup-claude-code.version") 2>/dev/null || { rm -f "$tmp"; true; }
}
clear_install_stamp() {
