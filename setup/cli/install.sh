#!/usr/bin/env bash
# openllm-self-sha256: 456e78f2d362a0ecb261009da477389166d7449278424f94f4b34216aae11a4f
...
record_install_stamp() {
  ...
  (umask 077; printf '%s' "1.6.39-registry.7" > "$tmp" && mv -f "$tmp" "$dir/setup-cli.version") 2>/dev/null || { rm -f "$tmp"; true; }
}
clear_install_stamp() {
