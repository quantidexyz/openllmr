#!/usr/bin/env bash
# openllm-self-sha256: 59ed88ac9129dc7f5d1d05496c71213616f5c30cb6d0ad3d220f0a046bc4cb47
...
# script as a child `bash` process — self-contained: `$OPENLLM_CLOUD_ORIGIN` arrives
